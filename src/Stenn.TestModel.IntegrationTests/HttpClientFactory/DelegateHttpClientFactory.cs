...
{
    /// <summary>
    /// Copy of original MS DefaultHttpClientFactory with custom creation of <see cref="HttpClient"/>
    /// </summary>
    internal class DelegateHttpClientFactory : IHttpClientFactory, IHttpMessageHandlerFactory
    {
        private static readonly TimerCallback _cleanupCallback = s => ((DelegateHttpClientFactory)s).CleanupTimer_Tick();
        private readonly ILogger _logger;
        private readonly IHttpClientActivator _activator;
        ...
        public DelegateHttpClientFactory(
            IHttpClientActivator activator,
            ...
            IEnumerable<IHttpMessageHandlerBuilderFilter> filters)
        {
            ...
            _logger = loggerFactory.CreateLogger<DelegateHttpClientFactory>();
        ...
        public HttpClient CreateClient(string name)
        {
            ...
            var client = _activator.CreateClient(handler, disposeHandler: false);
